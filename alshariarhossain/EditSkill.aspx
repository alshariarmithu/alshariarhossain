<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSkill.aspx.cs" Inherits="alshariarhossain.EditSkill" %>
...
<head runat="server">
    ...
    <title>Edit Skill - Portfolio Admin</title>
    ...
    <form id="form1" runat="server">
        <div class="form-container">
            ...
            <div class="form-header">
                <h1 class="form-title">Edit Skill</h1>
                <p class="form-subtitle">Update your skill information</p>
            </div>
            ...
            <div class="form-actions">
                ...
                <asp:Button ID="btnSave" runat="server" Text="Update Skill" CssClass="btn btn-primary" OnClick="btnSave_Click" />
            </div>
        </div>
    </form>
</body>
