<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProject.aspx.cs" Inherits="alshariarhossain.AddProject" %>
    ...
    <form id="form1" runat="server">
        <div class="form-container">
            ...
            <div class="form-header">
                <h1 class="form-title">Add New Project</h1>
                <p class="form-subtitle">Showcase your work with a new project</p>
            </div>
